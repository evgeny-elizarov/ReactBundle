...
export default defineMessages({
    accessDenied: 'Ошибка: Доступ к этой странице запрещен',
    whatHappened: 'Что произошло?',
    accessDeniedReasonOne: 'У вашей роли недостаточно прав для доступа к этой странице',
    accessDeniedReasonTwo: 'Администратор запретил вам доступ к этой странице',
    whatCanIDo: 'Что можно сделать?',
