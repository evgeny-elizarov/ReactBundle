<?php
namespace Andevis\ReactBundle\Compiler;

use Maba\Bundle\WebpackBundle\Compiler\WebpackCompiler as MabaWebpackCompiler;
...
class WebpackCompiler extends MabaWebpackCompiler
{
